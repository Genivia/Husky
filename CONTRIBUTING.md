...
- Ensure the bug was not already reported by searching on GitHub under
  [Issues](https://github.com/Genivia/Husky/issues).
...
You can create derivatives of Husky and freely distribute your derivatives
under the [GPL](LICENSE.txt) which should not be removed or altered.
